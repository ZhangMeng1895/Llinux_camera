 ...
 * 返 回 值： 0 - 成功, 其他值 - 失败
 ***********************************************************************/
int PicMerge(int iX, int iY, struct PixelDatas *ptSmallPic, struct PixelDatas *ptBigPic)
{
	int i;
 ...
 ***********************************************************************/
int PicMergeRegion(int iStartXofNewPic, int iStartYofNewPic, int iStartXofOldPic, int iStartYofOldPic, int iWidth, int iHeight, struct PixelDatas *ptNewPic, struct PixelDatas *ptOldPic)
{
	int i;
	unsigned char *pucSrc;
	unsigned char *pucDst;
